...
class BootStrap {
    ...
    def init = { servletContext ->
      ...
      nurse = new Nurse(firstname:"paweena", lastname:"chongngumleam" , user:"admin" , password:"admin")
       if (nurse.validate()) {
          nurse.save()
      }else println nurse.errors

      nurse = new Nurse(firstname:"Kanokon", lastname:"Chansom", user:"hippo", password:"1234")
      if (nurse.validate()) {
          nurse.save()
      }else println nurse.errors
     ...
     /*patient = new Patient(firstname:"Patient1",
      ...
      pharmacist = new Pharmacist(firstname:"ถิรวุฒิ",lastname:"ไชยชะอุ่ม",user:"champ",password:"1234")
